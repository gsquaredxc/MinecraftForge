...
public class CoreModManager {
    ...
    private static final String[] rootPlugins = {"net.minecraftforge.fml.relauncher.FMLCorePlugin", "net.minecraftforge.classloading.FMLForgePlugin"};
    ...
    private static void discoverCoreMods(File mcDir, LaunchClassLoader classLoader) {
        ...
        if (derpdirlist != null && derpdirlist.length > 0) {
            ...
            for (File f : derpdirlist) {
                FMLRelaunchLog.log.getLogger().log(Level.FATAL, "Directory {} contains {}", f.getName(), Arrays.asList(Objects.requireNonNull(new File(f, "META-INF").list())));
            }
